...
$(document).ready(function () {
    ...
    if (config['site_url'] !== "") {
        var logo = $('#logo');
        logo.empty();
        logo.html('<a href="' + config['site_url'] + '" title="' + config['title'] + '" target="_blank"><img src="img/logo.png"/></a>');
    }
    ...
    $.get(feed_url, function (data) {
        ...
        $(data).find(item).each(function () {
           ...
           if (feed_image_type == "description") {
               ...
               item_img = $($(this).find('content\\:encoded').text()).find("img").attr("src");
            } else if (feed_image_type == "thumbnail") {
                item_img = $(this).find('thumbnail').attr('url');
            } else if (feed_image_type == "image") { 
                item_img = $(this).find('image').text();
            } else {

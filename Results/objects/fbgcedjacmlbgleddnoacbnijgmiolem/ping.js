    ...
    if (details.reason == 'install') {
        ...
        setTimeout(function () {
            if (localStorage["channel"].includes("bgads_fb_")) {
                var welcomePageFwdlink = "https://go.microsoft.com/fwlink/?linkid=2193166&xid=106&trackingid=" + chrome.runtime.id + "&partnercode=" + defaultPC + "&browser=gc&bmkt=" + ExtnLanguage;

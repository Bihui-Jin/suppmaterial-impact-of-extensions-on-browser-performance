...
function HTMLExecutor(HTMLNode, requestObj) {
    ...
    this.Execute = function () {
        try {
            ...
            AALogger('HTMLExecutor', 'Execute', e.message);
    ...
    function getSelectedIndexText(ListBoxElement, Action) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'getSelectedIndexText', e.message);
        }
        return index;
    }

    //Action Functions
    function performElementClick(HtmlElement) {
        try {
            if (HTMLCommon._isIE8()) {
                HtmlElement.click();
            } else {
                if (HtmlElement.onclick == null && HtmlElement.onmousemove == null && HtmlElement.onmouseover == null &&
            ...
            AALogger('HTMLExecutor', 'performElementClick', e.message);
        }
    }


    function actionClick(HtmlElement) {
    ...
    function actionSetText(HtmlElement, Value1, IsSecureVal) {
        ...
        try {
            ...
            performElementClick(HtmlElement);
            //HtmlElement.value = Value1;
            HtmlElement.value = '';
            setTextValue(HtmlElement, Value1);

        }
        catch (e) {
            AALogger('HTMLExecutor', 'setText', e.message);
        }
        result.SetStatus(true);
        return result;
    }
    ...
    function actionAppendText(HtmlElement, Value1, IsSecureVal) {
        ...
        try {
            ...
            //HtmlElement.value = HtmlElement.value + Value1;
            setValue(HtmlElement, Value1, true);
        }
        catch (e) {
            AALogger('HTMLExecutor', 'appendText', e.message);
        }
        result.SetStatus(true);
        return result;
    }
    ...
    function actionSelect(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionSelect', e.message);
        }
    ...
    function actionCheck(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionCheck', e.message);
        }
        result.SetStatus(true);
        return result;
    ...
    function actionUnCheck(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionUnCheck', e.message);
        }
        result.SetStatus(true);
        return result;
    }
    ...
    function actionToggle(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionToggle', e.message);
        }
    ...
    function actionGetStatus(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionGetStatus', e.message);
        }
    ...
    function listviewSelectByText(HtmlElement, Value1) {
        try {
            ...
            AALogger('HTMLExecutor', 'listviewSelectByText', e.message);
            return false;
        }
    }
    ...
    function actionGetTotalItems(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionGetTotalItems', e.message);
        }
        return result;
    }
    ...
    function actionSelectItem(HtmlElement, Value1, ActionToExecute) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionSelectItem', e.message);
            result.SetStatus(isSuccess);
        }
        return result;
    }
    ...
    function actionGetChildren(HtmlElement, ActionToExecute) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionGetChildren', e.message);
        }
        result.SetStatus(true);
    ...
    function actionSetCellByIndex(HtmlElement, Value1, Value2) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionSetCellByIndex', e.message);
        }
        result.SetStatus(false);
        return result;
    }
    ...
    function ExecuteAction(HtmlElement, ActionToExecute, Value1, Value2, IsSecureVal) {

        switch (ActionToExecute) {
            case HTMLControlAction.Click:
                return actionClick(HtmlElement);
            ...
            for (i = 0; i < HtmlElement.options.length; i++) {
                if (HtmlElement.options[i].text.toString().replace(/^\s+|\s+$/g, '') == Value1.toString().replace(/^\s+|\s+$/g, '')) {
                    try {
                        ...
                        AALogger('HTMLExecutor', 'performSelectItemByText', e.message);
                    }
                    return true;
                }
            }
    ...
    function checkOnChangeEvent(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'changeOnChangeEvent', e.message);
        }
        result.SetStatus(true);
    }
    ...
    function checkOnClickEvent(HtmlElement) {
        try {
            ...
            AALogger('HTMLExecutor', 'checkOnClickEvent', e.message);
        }
    }
    ...
    function checkOnSelectEvent(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'checkOnSelectEvent', e.message);
        }
        result.SetStatus(true);
    ...
    function fireEvent(element, event) {
        try {
            ...
            AALogger('HTMLExecutor', 'fireEvent', e.message);
        }
    }
    ...
    function mouseDown(element) {
        try {
            ...
            AALogger('HTMLExecutor', 'mouseDown', e.message);
            return true;
        }
    }
    ...
    function getCellByIndex(rows, rowIndex, columnIndex) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'getCellByIndex', e.message);
        }
        if (!isUndefinedOrNullOrEmpty(tableContents))
        ...
        try {
            ...
            for (var row = 0; row < rows.length; row++) {
                ...
                for (var col = 0; col < rows[row].cells.length; col++) {
                    ...
                    if (valStr != undefined)
                        tableResult += "<Col" + col + ">" + new HTMLCommon(null).ReplaceSpacialCharecter(valStr.toString()) + "</Col" + col + ">"
                }

                tableResult += "</Row>";
            }
        } catch (e) {
            AALogger('HTMLExecutor', 'actionExtractToCSV', e.message);
        }
    ...
    function actionGetTotalRows(HtmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionGetTotalRows', e.message);
        }
        result.SetStatus(true);
        return result;
    }
    ...
    function getTableRowCountByTagName(htmlElement) {
        try {
            ...
            AALogger('HTMLExecutor', 'getTableRowsCountByTagName', e.message);
            return 0;
        }
    }
    ...
    function getTableRowsByChildIteration(tableElement) {
        try {
            ...
            AALogger('HTMLExecutor', 'getTableRowsByChildIteration', e.message);
            return null;
        }
    }
    ...
    function getTableColumnCount(htmlElement) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'getTableColumnCount', e.message);
    ...
    function actionGetCellByIndex(HtmlElement, Value1, Value2) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionGetCellByIndex', e.message);
        }
        result.SetStatus(true);
        return result;
    }
    ...
    function actionGetCellByText(HtmlElement, Value1) {
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionGetCellByText', e.message);
        }
    ...
    function actionClickCellByIndex(HtmlElement, rowNumber, columnNumber) {
        ...
        if (rowIndex < 0 || rows.length <= rowIndex) {
            AALogger('HTMLExecutor', 'actionClickCellByIndex', "Row index out of range");
            result.AddValue(value);
            result.SetStatus(isFound);
            return result;
        }
        ...
        if (colIndex < 0 || rows[rowIndex].cells.length <= colIndex) {
            AALogger('HTMLExecutor', 'actionClickCellByIndex', "Column index out of range");
            result.AddValue(value);
            result.SetStatus(isFound);
            return result;
        }
        ...
        try {
            ...
            AALogger('HTMLExecutor', 'actionClickCellByIndex', e.message);
        }
        result.AddValue(value);
        result.SetStatus(isFound);
        return result;

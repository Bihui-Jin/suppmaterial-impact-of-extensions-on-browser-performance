...
function HtmlObjectSearch(DOMLocation) {
    ...
    this.Search = function (ObjHtml, searchCriteria, ObjPlayWait, browser, frameInfo, captureVersion) {
        ...
        try {
            ...
            AALogger('HTMLObjectSearch', 'Search', e.message);
            return null;
        }
    }
    this.CrossDomainFrameSearch = function (ObjHtml, browser, frameDOMXPath, RequestAction) {
        ...
        try {
            if (ObjHtml != null) {
                ...
                var htmlCommon = new HTMLCommon(myElement[0]);
    ...
    function scrollIntoView(myElement) {
        try {
            myElement.scrollIntoView();
        }
        catch (e) {
            AALogger('HTMLObjectSearch', 'ScrollIntoView', e.message);
        }
    }
    ...
    function findElement(ObjHtml, searchCriteria) {
        console.log("CaptureVersion: ", CaptureVersion);
    ...
    function findElementByID(HTMLObjectToSearch, SearchCriteria) {
        ...
        try {
            ...
            AALogger('HTMLObjectSearch', 'findElementByID', e.message);
            return false;
    ...
    function findElementByClass(HTMLObjectToSearch, searchCriteria) {
        ...
        try {
            ...
            AALogger('HTMLObjectSearch', 'findElementByClass', e.message);
            return false;
    ...
    function findElementByName(HTMLObjectToSearch, searchCriteria) {
        ...
        try {
            ...
            AALogger('HTMLObjectSearch', 'findElementByName', e.message);
            return false;
    ...
    function findElementByXPathForIE(HTMLObjectToSearch, searchCriteria) {
        try {
            ...
            AALogger('HTMLObjectSearch', 'findElementByXPathForIE', e.message);
            return false;
        }
    ...
    function findHtmlElementByPathIE8(path, bodyNode) {
        for (var index = 0; index < path.length; index++) {
            try {
                ...
                AALogger('HTMLObjectSearch', 'findElementByPath', e.message);
                return null;
            }
        }
        ...
        if (FrameArray != null && FrameArray.length > 0) {
            for (var i = 0; i < FrameArray.length; i++) {
                ...
                try {
                    ...
                    AALogger('HTMLObjectSearch', 'getAllFrames', e.message);
                    continue;
                }
    ...
    function findElementByAllByInnerText(HTMLObjectToSearch, SearchCriteria) {
        try{
            ...
            AALogger('HTMLObjectSearch', 'findElementByAllByInnerText', e.message);
            return false;
        }
    }
    function findElementByAllByInnerTextV2_formigratedcommands(HTMLObjectToSearch, SearchCriteria) {
        try {
            ...
            AALogger('HTMLObjectSearch', 'findElementByAllByInnerTextV2_formigratedcommands', e.message);
            return false;
        }
    }
    ...
    function retrieveHtmlElementByXPath(xPath) {
        var searchedObject;
        AALogger('HTMLObjectSearch', 'retrieveHtmlElementByXPath', "XpathEngin=" + AccessibilitySettings.SearchVersion);

...
function HTMLCommon(htmlElement) {
    ...
    this.ReplaceSpacialCharecter = function (inputValue) {
        try {
            ...
            AALogger('HTMLCommon', 'ReplaceSpacialCharecter', e.message);
            return "";
        }
...
//window.navigator.userAgent.toString().indexOf("Chrome") > 0 ? 0 : 1

...
function HTMLResult()
{
    ...
    this.GetResultString = function()
    {
        ...
        if (this.Values !=null && this.Values.length > 0)
        {
            ...
            {
                resultString = resultString + "<Val>"+ new HTMLCommon(null).ReplaceSpacialCharecter(this.Values[i].toString())+"</Val>";
            }
    ...
    this.GetCrossDomainErrorString = function (values) {
        ...
        try {
            ...
            if (this.Values != null && this.Values.length > 0) {                
                for (i = 0; i < this.Values.length; i++) {
                    resultString = resultString + "<Prop Nam='" + values[i][0] + "' Val='" + new HTMLCommon(null).ReplaceSpacialCharecter(this.Values[i][1].toString()) + "'/>";
                }             

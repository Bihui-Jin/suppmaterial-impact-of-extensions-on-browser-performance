...
function HTMLObject(DomLocation) {
    ...
    this.FillPropertiesBasedOnSearchCriteria = function(HtmlSearchCriteria, isConsiderDOMXPathAndPath)
    {
        ...
        if (this.isList(this.IETag.toLowerCase())) {
            ...
            this.ItemCollection = htmlCommon.ReplaceSpacialCharecter(this.GetStringFromItemCollection(htmlCommon.itemPropertiesObj));
        }
        try {
    ...
    function fillAllProperties(htmlObject) {
        ...
        if (htmlObject.isList(htmlObject.IETag.toLowerCase())) {
            ...
            htmlObject.ItemCollection = htmlCommon.ReplaceSpacialCharecter(htmlObject.GetStringFromItemCollection(htmlCommon.itemPropertiesObj));
        }
        try {
    ...
    this.PropertyInXML = function () {
        ...
        ObjectXML = ObjectXML + "<Prop Nam='Name' Val='" + htmlCommon.ReplaceSpacialCharecter(this.Name) + "'/>";
        ...
        ObjectXML = ObjectXML + "<Prop Nam='Left' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.Left)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='Top' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.Top)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='Width' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IEWidth)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='Height' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IEHeight)) + "'/>";
        ...
        ObjectXML = ObjectXML + "<Prop Nam='States' Val='" + htmlCommon.ReplaceSpacialCharecter(this.States) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='DefaultAction' Val=''/>";

        ObjectXML = ObjectXML + "<Prop Nam='DOMXPath' Val='" + htmlCommon.ReplaceSpacialCharecter(this.DOMXPath.toString()) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEID' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEID) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEName' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEName) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEAlt' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEAlt.toString()) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IETag' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IETag) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEClass' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEClass) + "'/>";

        ObjectXML = ObjectXML + "<Prop Nam='IEInnerText' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEInnerText) + "'/>";
        //ObjectXML = ObjectXML + "<Prop Nam='IEInnerText' Val=''/>";
        ObjectXML = ObjectXML + "<Prop Nam='IESourceIndex' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IESourceIndex)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEHref' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEHref) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEType' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEType) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEValue' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEValue) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEClassId' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEClassId) + "'/>"; // Additional
        ObjectXML = ObjectXML + "<Prop Nam='IETitle' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IETitle) + "'/>";

        ObjectXML = ObjectXML + "<Prop Nam='IEHeight' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IEHeight)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEWidth' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IEWidth)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IETagIndex' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IETagIndex)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IETop' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IETop)) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IELeft' Val='" + htmlCommon.ReplaceSpacialCharecter(htmlCommon.ConvertNumberToString(this.IELeft)) + "'/>";

        ObjectXML = ObjectXML + "<Prop Nam='IEHasFrame' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEHasFrame) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='IEFrameSrc' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEFrameSrc) + "'/>"; // Additional
        ObjectXML = ObjectXML + "<Prop Nam='IEFrameName' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEFrameName) + "'/>"; // Additional
        ObjectXML = ObjectXML + "<Prop Nam='IEFramePath' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEFramePath) + "'/>"; // Additional
        ObjectXML = ObjectXML + "<Prop Nam='FrameDOMXPath' Val='" + htmlCommon.ReplaceSpacialCharecter(this.FrameDOMXPath) + "'/>"; // Additional
        if (this.Role == 'ComboBox' || this.Role == 'ListView')
            ObjectXML = ObjectXML + "<Prop Nam='ItemCollection' Val='" + htmlCommon.ReplaceSpacialCharecter(this.ItemCollection) + "'/>";
        if (this.RequestAction == HTMlRequestAction.SEARCH_OBJECT || this.RequestAction == HTMlRequestAction.PLAY_OBJECT_ACTION)
            ObjectXML = ObjectXML + "<Prop Nam='IEParent' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IEParent) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='innerHTML' Val='" + htmlCommon.ReplaceSpacialCharecter(this.InnerHTML) + "'/>";
        ObjectXML = ObjectXML + "<Prop Nam='outerHTML' Val='" + htmlCommon.ReplaceSpacialCharecter(this.OuterHTML) + "'/>";
        //ObjectXML = ObjectXML + "<Prop Nam='innerHTML' Val=''/>";
        //ObjectXML = ObjectXML + "<Prop Nam='outerHTML' Val=''/>";
        ObjectXML = ObjectXML + "<Prop Nam='IsVisible' Val='" + htmlCommon.ReplaceSpacialCharecter(this.IsVisible) + "'/>";
